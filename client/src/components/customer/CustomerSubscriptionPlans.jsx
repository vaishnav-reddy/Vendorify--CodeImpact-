...
import { Check, Star, Crown, Truck, Heart, Gift, X, Sparkles } from 'lucide-react';
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <div className="bg-[#CDF546] text-gray-900 px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-1">
                    <Sparkles size={12} />
                    Recommended
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-[#1A6950] to-emerald-700 rounded-[24px] p-8 text-white mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="font-bold text-lg mb-2">Exclusive Deals</h4>
              <p className="text-white/80">
        ...
        <div className="bg-[#CDF546] rounded-[24px] p-6 text-gray-900">
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-4">
              See how much you can save with Vendorify Plus
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
              ...
              <div className="bg-white rounded-2xl p-4 text-center">
                <div className="text-2xl font-black text-[#1A6950] mb-1">₹200</div>
            ...
            <p className="text-xs text-gray-600 mt-2">
              *Based on average customer usage of 8-10 orders per month
            </p>
          </div>
        </div>
